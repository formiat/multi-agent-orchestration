---
name: update-mr
description: Create or update GitLab MR for the current branch. Creates a new MR if none exists, or updates the description of the existing one. Preserves Notion link and other existing content.
user-invocable: true
---
