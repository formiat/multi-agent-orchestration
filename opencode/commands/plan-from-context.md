---
description: Create or refine PLAN.md from freeform context and current branch state.
agent: build
---
...
Read `./.codex/inbox.md` first and treat it as the authoritative planning request for this run. `$ARGUMENTS` may be empty or may repeat the same context; if both are present, `./.codex/inbox.md` wins.
...
The authoritative planning request may include:
